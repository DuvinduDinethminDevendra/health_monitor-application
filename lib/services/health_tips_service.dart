...
class HealthTipsService {
  static const String _baseUrl = kIsWeb
      ? 'https://corsproxy.io/?https://health.gov/myhealthfinder/api/v3/topicsearch.json'
      ...
      if (response.statusCode == 200) {
        ...
        return resources.take(15).map((item) {
          return HealthTip(
            ...
            content:
                _stripHtml(item['Sections']?['section']?[0]?['Content'] ?? ''),
  ...
  List<HealthTip> _getFallbackTips() {
    return [
      ...
      HealthTip(
        ...
        content:
            'Aim for 7-9 hours of quality sleep each night. Good sleep improves mood, memory, and overall health.',
        url: '',
      ),
      HealthTip(
        ...
        description: 'Fitness',
        content:
            'Get at least 150 minutes of moderate aerobic activity or 75 minutes of vigorous activity per week.',
        url: '',
      ),
      HealthTip(
        ...
        description: 'Nutrition',
        content:
            'Fill half your plate with fruits and vegetables at each meal for essential vitamins and minerals.',
        url: '',
      ),
      HealthTip(
        title: 'Manage Stress',
      ...
      HealthTip(
        ...
        content:
            'Schedule regular health screenings and checkups to detect potential issues early.',
        url: '',
      ),
      HealthTip(
      ...
      HealthTip(
        ...
        description: 'Fitness',
        content:
            'Maintain proper posture while sitting and standing to prevent back pain and improve breathing.',
        url: '',
      ),
    ];
  }
